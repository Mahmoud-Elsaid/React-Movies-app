...
export default function Register() {
    ...
    async function submitFormData(e){
        ...
        try
        {
            let response = await axios.post("http://localhost:8080/user/addUser" , user);
    ...
    function validateFormData(){
        let shcema = Joi.object({
            fullName:Joi.string().required().min(3).max(10),
        ...
        <div className=" my-3 w-75 m-auto">
            ...
            <form onSubmit={submitFormData}>
                ...
                <div className=" input-group  my-2 ">
                    <label className="ms-2 fw-bolder" htmlFor="fullName">full name:</label>
                    <input onChange={getFormValue} type="text" id="fullName" name="fullName" className=" w-100  p-2 mb-3 mt-2" />
                </div>
                ...
                <div className=" input-group  my-2 ">
                    <label className="ms-2 fw-bolder" htmlFor="Email">Email:</label>
                    <input onChange={getFormValue} type="email" id="Email" name="email" className=" w-100  p-2 my-3" />
                </div>
